        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="#newsletter" class="bg-indigo-600 text-white px-6 py-2 rounded-full hover:bg-indigo-700">
                        Subscribe
                    </a>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 mb-4">Exploring the latest trends and innovations in modern web
                        development...</p>
                    <div class="flex items-center">
                        <img src="https://source.unsplash.com/random/100x100" alt="Author"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="max-w-md mx-auto flex gap-4">
                <form  method="POST" action="/subscribe" class="flex gap-4">
                    ...
                    <button type="submit" class="bg-indigo-600 text-white px-8 py-3 rounded-full hover:bg-indigo-700">
                        Subscribe
                    </button>
                </form>
            </div>
